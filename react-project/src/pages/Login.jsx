                            ...
                            {step === 'login' ? (
                                ...
                                >
                                    ...
                                    <div className="text-center mb-10">
                                        ...
                                        <h1 className="text-3xl font-display font-black tracking-widest uppercase mb-2">Welcome Back</h1>
                                        <div className="flex items-center justify-center gap-2">
                                            <div className="w-1.5 h-1.5 rounded-full bg-accent animate-pulse" />
                                            <p className="text-[10px] uppercase font-bold text-white/40 tracking-[0.2em]">Continue Your Evolution</p>
                                        </div>
                                    </div>
